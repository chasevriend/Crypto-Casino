                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{coin.market_data?.price_change_percentage_30d_in_currency.usd ? <p>{coin.market_data.price_change_percentage_30d_in_currency.usd}%</p> : null}</td>
                                <td>{coin.market_data?.price_change_percentage_1y_in_currency.usd ? <p>{coin.market_data.price_change_percentage_1y_in_currency.usd}%</p> : null}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
